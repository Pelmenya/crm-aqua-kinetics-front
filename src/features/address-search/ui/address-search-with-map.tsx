...
import { setRealEstateAddress, setRealEstateCoordinates } from '@/pages/add-house/model/real-estate-slice';
import { getRealEstateAddress, getRealEstateCoordinates } from '@/pages/add-house/model/real-estate-selectors';
